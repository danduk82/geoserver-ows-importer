...
class DefaultApi(object):
    ...
    def fake_op(self, **kwargs):  # noqa: E501
        """fake_op  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fake_op(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.fake_op_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.fake_op_with_http_info(**kwargs)  # noqa: E501
            return data

    def fake_op_with_http_info(self, **kwargs):  # noqa: E501
        """fake_op  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fake_op_with_http_info(async_req=True)
        >>> result = thread.get()
