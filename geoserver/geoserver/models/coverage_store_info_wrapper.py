...
class CoverageStoreInfoWrapper(object):
    ...
    """
    swagger_types = {
        'coverage_store': 'CatalogYamlcomponentsschemasCoverageStoreInfo'
    }
    ...
    def coverage_store(self):
        ...
        :rtype: CatalogYamlcomponentsschemasCoverageStoreInfo
        """
    ...
    def coverage_store(self, coverage_store):
        ...
        :type: CatalogYamlcomponentsschemasCoverageStoreInfo
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CoverageStoreInfoWrapper, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CoverageStoreInfoWrapper):
            return False
